...
**风格指南8个维度**（LLM分析）：
1. 叙事声音与语气（冷峻/热烈/讽刺/温情，附原文例句）
2. 对话风格（句子长短、口头禅倾向、方言痕迹、对话节奏）
3. 场景描写特征（五感偏好、意象选择、描写密度）
4. 转折与衔接手法（场景切换、时间跳跃、段落过渡）
5. 节奏特征（长短句分布、段落长度偏好、高潮/舒缓交替）
6. 词汇偏好（高频特色用词、比喻/修辞倾向、口语化程度）
7. 情绪表达方式（直白抒情vs动作外化、内心独白频率）
8. 独特习惯（任何值得模仿的个人写作习惯）
