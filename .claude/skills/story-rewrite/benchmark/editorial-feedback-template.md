...
| 反馈类型 | 修改文件 | 修改位置 |
|----------|----------|----------|
| 网络梗堆砌 | `.claude/skills/story-rewrite/references/narrator-persona.md` | 对应人格类型的"语言特征" |
| 语感样本重复 | `.claude/skills/story-rewrite/references/narrator-persona.md` | "实际仿写时"说明 |
