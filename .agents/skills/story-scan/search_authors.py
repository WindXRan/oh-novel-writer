...
base_url = "http://127.0.0.1:18423/api/search?q="
authors_to_search = ["菠萝别挡路", "檐上歌", "龙井糯团", "沐北川", "恩小沫"]

all_books = []
for author in authors_to_search:
    url = base_url + urllib.parse.quote(author)
    try:
        ...
        with urllib.request.urlopen(req, timeout=15, context=ctx) as resp:
            ...
            for item in items[:3]:
                ...
                author_name = decode_text(raw_author)
                all_books.append({
                    'search': author,
                    'book_id': book_id,
                    'title': title,
                ...
                print("Found: {} by {} (id: {})".format(title, author_name, book_id))
    except Exception as e:
        print("Error searching {}: {}".format(author, e))

with open('book_ids.json', 'w', encoding='utf-8') as f:
    json.dump(all_books, f, ensure_ascii=False, indent=2)
print("\nTotal: {} books found".format(len(all_books)))
